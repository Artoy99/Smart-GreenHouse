...
HD_PWD='C:/Users/ecx/Documents/TP_SINT_JOST_COLLINEAU/TP_SINT/TP_SINT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_manip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_manip.tcl
