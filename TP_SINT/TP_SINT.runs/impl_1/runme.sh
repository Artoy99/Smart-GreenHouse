...
HD_PWD='C:/Users/ecx/Documents/TP_SINT_JOST_COLLINEAU/TP_SINT/TP_SINT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_manip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_manip.tcl -notrace
